  ...
  require("diffview").setup({
    ...
    keymaps = {
      ...
      view = {
        ...
        { "n", "<Space>e", actions.focus_files, { desc = "Bring focus to the file panel" } },
        { "n", "<Space>b", actions.toggle_files, { desc = "Toggle the file panel." } },
        { "n", "g<C-x>", actions.cycle_layout, { desc = "Cycle through available layouts." } },
        { "n", "g<C-j>", actions.next_entry, { desc = "In the view: bring the cursor to the next entry" } },
        { "n", "g<C-k>", actions.select_prev_entry, { desc = "In the view: bring the cursor to the prev entry" } },
        { "n", "[x", actions.prev_conflict, { desc = "In the merge-tool: jump to the previous conflict" } },
        { "n", "]x", actions.next_conflict, { desc = "In the merge-tool: jump to the next conflict" } },
        { "n", "<Space>co", actions.conflict_choose("ours"), { desc = "Choose the OURS version of a conflict" } },
        { "n", "<Space>ct", actions.conflict_choose("theirs"), { desc = "Choose the THEIRS version of a conflict" } },
        { "n", "<Space>cb", actions.conflict_choose("base"), { desc = "Choose the BASE version of a conflict" } },
        { "n", "<Space>ca", actions.conflict_choose("all"), { desc = "Choose all the versions of a conflict" } },
